  ...
  return <section className="mx-auto max-w-[1600px] p-3 pb-8 md:p-5">
    ...
    <div className="mb-4 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
      ...
      <div className="flex flex-wrap items-center gap-1.5">
        ...
        <div className="order-last flex w-full items-center gap-1.5 sm:order-none sm:w-auto"><button type="button" aria-label={t('previous')} onClick={() => moveRange(-14)} className="rounded-xl border border-slate-200 bg-white p-2 text-slate-600 hover:bg-slate-50"><ChevronLeft size={16}/></button>
