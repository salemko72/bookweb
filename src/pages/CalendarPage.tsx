    ...
    <div ref={timelineRef} data-testid="calendar-timeline" className="overflow-x-auto rounded-[1.35rem] border border-[#ded7cd] bg-white">
      <div className="relative min-w-max" style={{ width: ROW_LABEL_WIDTH + days.length * dayWidth }}>
        ...
        {orderedProperties.map(property => {
          ...
          return <div key={property.id} data-testid="calendar-property-row" draggable={!sortOn} onDragStart={()=>setDraggedProperty(property.id)} onDragOver={e=>e.preventDefault()} onDrop={()=>dropProperty(property.id)} className="flex border-b border-slate-100" style={{minHeight:laneCount * LANE_HEIGHT + 15}}>
