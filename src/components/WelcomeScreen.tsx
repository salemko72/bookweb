...
const copy = {
  hr: {
    eyebrow: 'POMAAALOSTAY', title: 'Jednostavno upravljanje vašim smještajem.', body: 'Nekretnine, rezervacije, gosti i dnevni poslovi ostaju uredno odvojeni za svaki tim.',
  ...
  en: {
    eyebrow: 'POMAAALOSTAY', title: 'Simple management for your rental.', body: 'Properties, bookings, guests and daily operations stay clearly separated for every team.',
