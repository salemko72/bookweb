...
describe('AddressAutocomplete', () => {
  ...
  it('keeps manual address entry quiet until search is enabled', async () => {
    const onChange = vi.fn()
    render(<AddressAutocomplete value={{ address: 'Old address', city: 'Split', latitude: null, longitude: null }} onChange={onChange} />)
    ...
    expect(onChange).toHaveBeenCalledWith({ address: 'New manual address', city: 'Split', latitude: null, longitude: null })
  })
})
